...
$del_con = Yii::t('admin_post', 'Are you sure you want to delete this post?');
$del_title=Yii::t('admin_post', 'Delete Confirmation');
 $del=Yii::t('admin_post', 'Delete');
...
<?php
    ...
    array(
                   'class' => 'CButtonColumn',
                    'buttons' => array(
                                                     'post_delete' => array(
                                                     'label' => Yii::t('admin_post', 'Delete'), // text label of the button
                                                      ...
                                                      'options' => array("class" => "fan_del", 'title' => Yii::t('admin_post', 'Delete')), // HTML options for the button   tag
                                                      ),
                                                     'post_update' => array(
                                                     'label' => Yii::t('admin_post', 'Update'), // text label of the button
                                                     'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                     ...
                                                     'options' => array("class" => "fan_update", 'title' => Yii::t('admin_post', 'Update')), // HTML options for the    button tag
                                                        ),
                                                     'post_view' => array(
                                                      'label' => Yii::t('admin_post', 'View'), // text label of the button
                                                      'url' => '$data->id', // a PHP expression for generating the URL of the button
                                                      ...
                                                      'options' => array("class" => "fan_view", 'title' => Yii::t('admin_post', 'View')), // HTML options for the    button tag
                                                        )
                                                    ),
                   'template' => '{post_view}{post_update}{post_delete}',
            ),
    ),
 ...
 //VIEW
    ...
    $('.fan_view').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/post/returnView",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                beforeSend : function() {
                    $("#post-grid").addClass("ajax-sending");
                },
                complete : function() {
                    $("#post-grid").removeClass("ajax-sending");
                },
...
//UPDATE
    ...
    $('.fan_update').each(function(index) {
        ...
        $(this).bind('click', function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/post/returnForm",
                ...
                success: function(data) {
                    $.fancybox(data,
                            {    "transitionIn"    :  "elastic",
                                ...
                                $.fn.yiiGridView.update('post-grid', {url:'',data:{"Post_page":page}});
                                }//onclosed
                            });//fancybox
                    //  console.log(data);
                } //success
...
// DELETE
    ...
    $('.fan_del').each(function(index) {
        ...
        deletes[id] = function() {
            $.ajax({
                type: "POST",
                url: "<?php echo Yii::app()->request->baseUrl;?>/post/ajax_delete",
                data:{"id":id,"YII_CSRF_TOKEN":"<?php echo Yii::app()->request->csrfToken;?>"},
                    beforeSend : function() {
                    $("#post-grid").addClass("ajax-sending");
                },
