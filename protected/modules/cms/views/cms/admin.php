...
$this->menu=array(
    array('label'=>'Add Page', 'url'=>array('create','type'=>Cms::PAGE,
	'parent_id'=>$parent_id)),
    array('label'=>'Add Set of Pages', 'url'=>array('create','type'=>Cms::PAGESET,
	'parent_id'=>$parent_id)),
	array('label'=>'Add Link', 'url'=>array('create','type'=>Cms::LINK,'parent_id'=>$parent_id)),
    array('label'=>'View '.$page->name,'url'=>array('view','id'=>$page->id)),
    array('label'=>'Update '.$page->name,'url'=>array('update','id'=>$page->id)),
);
